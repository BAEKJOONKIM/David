...
<body>
	...
	<div class="container">
		<div class="row">
			<div class="col"></div>
			<div class="col-8">
				<form action="./board_write_action">
					<p class="text-center title my-5">새 게시글</p>
					<hr>
					<br>
					<div class="row">
					...
					<div class="row mt-4">
						...
						<div class="col">
							<input type="text" name="brd_ttl" placeholder="제목을 작성해주세요"
								class="form-control">
						</div>
					</div>
					<div class="row my-4">
						...
						<div class="col">
							<textarea rows="7" cols="50" name="brd_con"
								placeholder="내용을 작성해주세요" class="form-control"></textarea>
						</div>
					</div>
					<br>
					<div class="row mt-5">
