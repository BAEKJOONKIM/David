...
<c:if test="${sessionUserData.mbr_idx != data.memberVo.mbr_idx }">
		...
		<div class="row">
			...
			<div class="col text-center">
				...
				<h1>글 작성자만 접근 가능합니다</h1>
				<br> <a type="button" class="btn btn-warning" href="main_page">메인페이지
					가기</a>
			</div>
			<div class="col-2"></div>
		</div>
	...
	<div>
		...
		<div class="row">
			...
			<div class="col">
				...
				<form id="update_content_form"
					action="./update_workout_action?wrk_idx=${data.workOutVo.wrk_idx }"
					...
					<div class="form-group">
						<label for="text">제목</label> <input class="form-control"
							type="text" id="wrk_ttl" name="wrk_ttl"
							value="${data.workOutVo.wrk_ttl }" />
					</div>
					<div class="form-group">
						<label for="exampleFormControlTextarea1">내용</label>
						<textarea class="form-control" id="wrk_con" rows="3"
							name="wrk_con">${data.workOutVo.wrk_con }</textarea>
					</div>
					<div class="form-group">
				...
				<div class="button-group">
					<button class="btn btn-warning" onclick="update_process()">수정</button>
